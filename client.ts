    ...
    for (let i = 0; i < n; i++) {
        ...
        try {
            ...
            if (error.message.includes('Channel has been shut down')) {
                // Handle the error - you may want to reinitialize the client or retry the transaction
                console.log('Reinitializing the connection...');
                // Reinitialize the contract or perform other error handling here
            }
        }
    }
